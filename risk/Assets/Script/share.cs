...
{
    string subject = "Hey I am playing this awesome new game called RİSK,do give it try and enjoy \n";
    string body = "https://play.google.com/store/apps/details?id=com.DefaultCompany.risk";
